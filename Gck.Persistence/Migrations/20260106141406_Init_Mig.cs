        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsMale = table.Column<bool>(type: "bit", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_HourlyFee", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tbl_Session_tbl_HourlyFee_FeeId",
                        column: x => x.FeeId,
                        principalTable: "tbl_HourlyFee",
                        principalColumn: "Id",
